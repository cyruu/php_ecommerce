...
<body style="background:rgba(242, 242, 242, 1);position:relative;">
    ...
    include("sub_files/_dbconnect.php");
      ...
      include("sub_files/_slider.php");
      echo '
      <div class="cat" style="width:23%;height:79%;position:absolute;top:480px;left:0px;">
      ';
    ...
    include("trendingslider.php");
      ...
      echo '<div style="width:73%;margin-left:350px;">';
        echo '<div class="h2 my-4">Browse Products</div>';
        ...
        while($item = mysqli_fetch_assoc($result))
        {
            ...
            // card
            echo'
                <div class="card my-4" style="width: 260px; height:370px;">
